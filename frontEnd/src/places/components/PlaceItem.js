...
const PlaceItem = props => {
    ...
    footerClass= 'place-utem__modal-actions'
    footer={<Button onClick={closeMapHandler}>CLOSE</Button>} > 
    <div className="map-container">
    <iframe title="map" width="100%" height="100%" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" 
    src={'https://maps.google.com/maps?q=' + props.coordinates.lat.toString() + ',' + props.coordinates.lng.toString() 
    ...
    footer={
        ...
        <p>Do you want to proceed and delete this place? PLease note that it cannot be undone therafter.</p>
    </Modal>
    <li className="place-item">
        <Card className='placr-item__content'>
